 ...
 * @author UmamiAppearance [mail@umamiappearance.eu]
 * @license MIT
 */let J;if(void 0===X)throw new Error("BaseEx is required for this module to work. Please make sure the whole library or the BaseEx class can be globally found under the name 'BaseEx'.");J="BaseEx"in X?new X.BaseEx:new X;const Q=["SHA-1","SHA-256","SHA-384","SHA-512"],Z=["raw","jwk"];class tt{#d=null;#f=null;#p=null;#g=[];#y=null;#w=this.constructor.keyFormats();#b=null;constructor(t){[this.#p,this.#d]=o(t,Q),this.#m()}static baseEx=J;static digestmodsAvailable(){return new Set(Q)}static keyFormats(){return new Set(Z)}static async generateKey(t="",e=!1){return t=o(t,Q).at(0),await s(t,e)}static compareDigest(t,e){if(void 0===t||void 0===e)throw new Error("HMACobj.compareDigest takes exactly two positional arguments.");let s,i;t=J.byteConverter.encode(t,"uint8"),e=J.byteConverter.encode(e,"uint8"),t.byteLength>e.byteLength?(s=t,i=e):(s=e,i=t);const r=s.map(((t,e)=>t===i.at(e)));return Boolean(r.reduce(((t,e)=>t*e)))}static async new(t=null,e=null,s="",i="raw",r=!1){const n=new this(s);return t&&("object"===i?await n.setKey(t):await n.importKey(t,i,r)),null!==e&&(t||(await n.generateKey(),console.warn("A message but no key was provided. The key was generated for you.")),await n.update(e)),n}get digestSize(){return this.#d/8}get blockSize(){return this.#d>256?128:64}get name(){return"HMAC-"+this.#p}#v(t){return J.byteConverter.encode(t,"bytes")}#E(t){if(!this.#w.has(t))throw new TypeError(`Invalid key format '${t}'\n\nValid formats are: ${Z.join(", ")}`)}#A(){if(null===this.#y)throw new Error("No key is assigned yet. Import or generate key.")}#x(t,e){const s="Invalid base conversion keyword.";var i;if(i=e.replace(/^to/,""),"hex"===(e=i.charAt(0).toLowerCase().concat(i.slice(1)))||"hexdigest"==e)e="base16";else if("bytes"===e)e="byteConverter";else if(/SimpleBase/i.test(e)){if(!((e="base"+(0|[].concat(String(e).match(/[0-9]+/)).at(0)))in J.simpleBase))throw new TypeError(s);return J.simpleBase[e].encode(t)}if(!(e in J))throw new TypeError(s);return J[e].encode(t)}async update(t,e=!1){t=this.#v(t),this.#A(),this.#g=e?Array.from(t):this.#g.concat(Array.from(t)),this.#f=await r(Uint8Array.from(this.#g),this.#y)}async replace(t){await this.update(t,!0)}async setKey(t){this.#y=t,this.#g.length&&(console.warn("A new crypto key was established. A fresh digest is now getting calculated."),this.#f=await r(Uint8Array.from(this.#g),this.#y))}async importKey(t,s="raw",i=!1){"raw"===s?t=this.#v(t):this.#E(s),this.#b=i;const r=await e(t,this.#p,s,i);await this.setKey(r)}async generateKey(t=!0){this.#b=Boolean(t);const e=await s(this.#p,this.#b);await this.setKey(e)}async exportKey(e="raw"){if(this.#E(e),null===this.#y)throw new Error("Key is unset.");if(!this.#b)throw new t("Key exports are not allowed. You have to permit this before key-generation.");return await i(this.#y,e)}async copy(){return await this.constructor.new(this.#y,this.#g.length?Uint8Array.from(this.#g):null,this.#p,"object",this.#b)}async sign(t,e=null){this.#A(),t=this.#v(t);const s=await r(t,this.#y);return null!==e?this.#x(s,e):s}async verify(t,e){if(t=this.#v(t),this.#A(),null===this.signature)throw new TypeError("Signature must be provided");return await n(t,e,this.#y)}digest(){return this.#f}#m(){const t=(t,e)=>t.splice(t.indexOf(e),1),e=t=>t.charAt(0).toUpperCase().concat(t.slice(1));this.hexdigest=()=>this.#f?J.base16.encode(this.#f):null;const s=Object.keys(J);this.basedigest={toSimpleBase:{}},t(s,"base1"),t(s,"byteConverter"),t(s,"simpleBase");for(const t of s)this.basedigest[`to${e(t)}`]=(...e)=>this.#f?J[t].encode(this.#f,...e):null;for(const t in J.simpleBase)this.basedigest.toSimpleBase[e(t)]=(...e)=>this.#f?J.simpleBase[t].encode(this.#f,...e):null;this.basedigest.toBytes=(...t)=>this.#f?J.byteConverter.encode(this.#f,...t):null}}export{tt as default};
